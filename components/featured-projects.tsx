...
//                             </div>
//                         </motion.div>
//                         <Button className="bg-[#3D0C11] hover:bg-[#3D0C11]">View Project Details</Button>
//                     </div>
//                 </div>
...
//                         <Button
//                             key={project.id}
//                             className={project.id === activeProject.id ? "bg-[#3D0C11] hover:bg-[#3D0C11] text-white" : "bg-transparent hover:bg-gray-100 text-black"}
//                             onClick={() => setActiveProject(project)}
//                         >
//                             Project {project.id}
//                         </Button>
